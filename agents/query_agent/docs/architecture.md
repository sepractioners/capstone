...
flowchart LR
    ...
    Verify -. "unsupported claim\n(bounded redraft, ADR-0006)" .-> Draft
...
worse than not looping at all. See [ADR-0006](../../../docs/adr/0006-query-agent-routing-retrieval-and-self-correction.md).
