...
| [0007](0007-query-agent-template-response-formats.md) | Proposed | Query-agent template response formats and agent response clarity |
| [Implementation Plan](implementation-plan.md) | Reference | Phased rollout of query-agent routing overhaul (Phases 0-6, tracking progress and validation) |
